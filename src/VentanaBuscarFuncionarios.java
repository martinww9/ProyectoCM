...
public class VentanaBuscarFuncionarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Buscar funcionarios");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Funcionario funcionarioBuscado = sistema.buscarFuncionarioEnTodasLasCarteras(idFuncionario);
            JOptionPane.showMessageDialog(this, "Funcionario encontrado con éxito: " + funcionarioBuscado.getCargo()+ " " + funcionarioBuscado.getNombre() , "Éxito", JOptionPane.INFORMATION_MESSAGE);
