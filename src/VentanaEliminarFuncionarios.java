...
public class VentanaEliminarFuncionarios extends javax.swing.JFrame {
    ...
    public VentanaEliminarFuncionarios(Sistema sistema) {
    ...
    Funcionario funcionarioEliminada = sistema.buscarFuncionarioEnTodasLasCarteras(idFuncionario);
    CarteraMinisterial carteraDelFuncionario = sistema.obtenerCarteraDelFuncionario(idFuncionario);
    carteraDelFuncionario.eliminarFuncionario(idFuncionario);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaEliminarFuncionarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            VentanaEliminarFuncionarios ventanaC = new VentanaEliminarFuncionarios(sistema);
