...
public class VentanaAgregarFuncionarios extends javax.swing.JFrame {
    ...
    public VentanaAgregarFuncionarios(Sistema sistema) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Agregar Funcionarios");

        jLabel2.setText("Nombre Funcionario:");

        jLabel3.setText("Cargo Funcionario:");

        jLabel4.setText("ID de Funcionario:");

        jLabel5.setText("Cartera a la que pertenece:");
        ...
        jLabel6.setText("SI EXISTE O NO EL FUNCIONARIO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAgregarFuncionarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            VentanaAgregarFuncionarios ventanaA = new VentanaAgregarFuncionarios(sistema);
